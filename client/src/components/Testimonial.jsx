...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        {   name: "Siddharth Jain",
            ...
            testimonial: "CarRental made my trip so much easier. The car was delivered right to my door and the service was fantastic!" 
        },

        {   name: "Vaibhav Malhotra",
            location: "Bangalore", 
            image: assets.testimonial_image_1, 
            testimonial: "I highly recommend CarRental! Their service is amazing" 
        }
    ];
