  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            <label htmlFor="image">
                <img src={image ? URL.createObjectURL(image): user?.image || "https://unsplash.com/photos/a-concept-car-is-shown-in-the-dark-V1DFo8C4JPA" } alt='' className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto'/>
        ...
        {image && (
            <button className='absolute top-0 right-0 bg-primary/10 text-primary cursor-pointer' onClick={updateImage}>Save <img src={assets.check_icon} width={13} alt="" /> </button>
        )}
